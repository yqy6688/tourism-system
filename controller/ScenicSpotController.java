...
public class ScenicSpotController {
    ...
    public Result<?> getScenicSpotsByPage(
        ...
        Page<ScenicSpot> page = scenicSpotService.getScenicSpotsByPage(name, location, categoryId, tags, sortBy, currentPage, size);
    ...
    public Result<?> getScenicSpot(@PathVariable Long id) {
        List<TravelGuide> travelGuide = scenicSpotService.getTravelGuideById(id);
